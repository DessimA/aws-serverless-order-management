...
if ! aws iam get-role --role-name "$ROLE_NAME" >/dev/null 2>&1; then
    ...
    echo "Aguardando propagacao inicial do IAM..."
    sleep 15
fi
...
for OP in "${OPS[@]}"; do
    ...
    # 4. Trigger SQS -> Lambda (Com retry para consistencia de permissao)
...
# 6. Permissoes Finais da Role (SQS e DynamoDB)
echo "Aplicando permissoes finais na Role..."
