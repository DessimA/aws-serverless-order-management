...
# === Lambda Functions ===
for name in "order-persister-${RESOURCE_SUFFIX}" "order-lifecycle-cancel-${RESOURCE_SUFFIX}" "order-lifecycle-update-${RESOURCE_SUFFIX}" "order-file-validator-${RESOURCE_SUFFIX}" "order-pre-validator-${RESOURCE_SUFFIX}" "order-validator-${RESOURCE_SUFFIX}" "test-controller-${RESOURCE_SUFFIX}" "customer-auth-${RESOURCE_SUFFIX}" "catalog-reader-${RESOURCE_SUFFIX}" "order-gateway-${RESOURCE_SUFFIX}"; do
